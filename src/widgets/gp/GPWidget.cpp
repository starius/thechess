...
GPWidget::GPWidget(const GP* gp,
    ...
    limit_std_ = new Wt::Wc::TimeDurationWidget(min::LIMIT_STD,
            gp->limit_std(),
            max::LIMIT_STD);
    item(tr("tc.game.limit_std"), "", limit_std_->form_widget(), limit_std_);
    limit_private_init_ = new Wt::Wc::TimeDurationWidget(min::LIMIT_PRIVATE_INIT,
    ...
    pause_limit_init_ = new Wt::Wc::TimeDurationWidget(min::PAUSE_LIMIT_INIT,
            gp->pause_limit_init(),
    ...
    first_draw_ = new Wt::Wc::ConstrainedSpinBox();
